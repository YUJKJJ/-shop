...
SECRET_KEY = 'n^d(5yuwom(yllna*-5=psk_j&xk*h^f!r@#y10aysmpth2^vo'
...
# 云片网APIKEY
APIKEY='d29fcc12744b8208c8383dc2c7f4c457'

# 支付宝配置信息
APPID = '2016102300743771'
# 支付宝相关的key
private_key_path = os.path.join(BASE_DIR, 'app/trade/keys/private_daliu.txt')
ali_pub_key_path = os.path.join(BASE_DIR, 'app/trade/keys/alipay_key.txt')

# 买家测试账号
user_account = 'kgcrjt8821@sandbox.com'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://47.105.62.144:6379/1",
        "OPTIONS": {
